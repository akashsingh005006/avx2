...
import ticketSalesAbi from "/home/gamifyzone/Documents/Personal Work/MetaCrafters/TicketSales/artifacts/contracts/TicketSales.sol/TicketSales.json";
...
export default function App(){
    ...
    const buyTicket = async () => {
      if(ticketSalesSigner && amountEntered>0 && (amountEntered >= ticketPrice * ticketsEntered)){
        try{
          const valueInWei = ethers.parseUnits(amountEntered.toString(), "wei");

          let tx = await ticketSalesSigner.buyTicket({
            value: valueInWei,
      ...
      return (
        <div className="flex flex-col justify-center items-center w-full h-full gap-3">
          ...
          <p className="text-gray-300  text-2xl">
            Organizer address: {organizer !== undefined ? `${organizer}` : "Loading..."}
          </p>
          <p className="text-gray-300  text-2xl">
            Ticket Price:{" "}
